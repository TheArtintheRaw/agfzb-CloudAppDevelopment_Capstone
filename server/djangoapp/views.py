...
def get_dealer_details(request, dealer_id):
    if request.method == "GET":
        url_r = f"https://us-south.functions.appdomain.cloud/api/v1/web/9cdefb68-1fae-422f-9f07-1688674cba78/api/reviews?dealerId={dealer_id}"
        url_ds = f"https://us-south.functions.appdomain.cloud/api/v1/web/9cdefb68-1fae-422f-9f07-1688674cba78/api/get-dealerships?dealerId={dealer_id}"
        # Get dealers from the URL
        context = {
...
def add_review(request, dealer_id):
    ...
    if request.method == "POST":
        ...
        URL = 'https://us-south.functions.appdomain.cloud/api/v1/web/9cdefb68-1fae-422f-9f07-1688674cba78/api/reviews'
